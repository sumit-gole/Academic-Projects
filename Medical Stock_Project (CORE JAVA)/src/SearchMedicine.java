...
public class SearchMedicine extends JFrame implements ActionListener
{
   ...
   l11.setBounds(470,260,180,25);
 	...
 	l12.setBounds(470,300,180,25);
	    ...
	    scrlPane.setBounds(0,380,900,560);
        jf.add(scrlPane);
        ...
        // Set Background1 Image On Search Medicine Page..
		JLabel background;
		ImageIcon img=new ImageIcon(new ImageIcon("images//SearchMedicine.jpg").getImage().getScaledInstance(700,400,Image.SCALE_DEFAULT));
