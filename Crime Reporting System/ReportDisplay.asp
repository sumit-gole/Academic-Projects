...
<div class="TitleName" style="background-color: grey; height: 55px;-webkit-box-shadow: 0 8px 18px -6px black; -moz-box-shadow: 0 8px 6px -6px black; -box-shadow: 0 8px 6px -6px black;">
	...
	<h2 align="center" style="margin-top: -65px;"><p>-- COMPLAINT REPORT --</p></h2>
<style> 
	div.top{background:#18559B;}
</style>
</div><br>
...
sql="SELECT IDType,IDno,Victim_Name,VFatherName,Gender,VEmail,Mobile,DOB,VState,VCity,VPoliceStation,Accussed_Name FROM Complaint"
rs.Open sql, conn
%>
...
conn.Open "C:\inetpub\wwwroot\Crime Reporting System\CrimeDB\CrimeDB.mdb"
set rs = Server.CreateObject("ADODB.recordset")
sql="SELECT Accussed_Name,Accussed_Address,Accussed_Gender,NatureOfComplaint,IncidentDate,ActType,IncidentPlace,EvidenceDescription,UploadFile FROM Complaint"
rs.Open sql, conn
%>
