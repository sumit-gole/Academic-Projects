...
<div class="TitleName" style="background-color: grey; height: 55px;-webkit-box-shadow: 0 8px 18px -6px black; -moz-box-shadow: 0 8px 6px -6px black; -box-shadow: 0 8px 6px -6px black;">
	...
	<h2 align="center" style="margin-top: -65px;"><p>-- JUDGEMENT REPORT --</p></h2>
<style> 
	div.top{background:#18559B;}
</style>
</div><br>
...
conn.Open(Server.Mappath("CrimeDB/CrimeDB.mdb"))
set rs = Server.CreateObject("ADODB.recordset")
sql="SELECT JID,CmpID,CriminalID,CriminalName,Court,SectionNo,Judge,PoliceIncharge,SuspectName,SuspectAdrs,RegisterDate,FullReport FROM Judgement"
rs.Open sql, conn
%>
		...
		<div style="color: black;margin-top: -67px;margin-left: -290px;">
			<h2>VISIT US ON :</h2>
				<div style="margin-left: 400px;margin-top: -62px;">
					...
					<a href="#"><img src="Images\google.png" width="50" height="50"></a>
				</div>
		</div>
		<strong class="copy">
