...
Public Class SearchFormMostWanted
    ...
    Public Sub FilterData(ByVal valueToSearch As String)
        Dim searchQuery As String = "SELECT * From MostWanted Where Mid like '%" & TextBox1.Text & "%'"
    ...
    End Sub
    Private Sub SearchFormMostWanted_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FilterData("")
    End Sub
