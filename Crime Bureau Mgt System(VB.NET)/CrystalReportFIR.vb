...
Public Class CrystalReportFIR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.CrystalReportFIR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportFIR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportFIR = New CrystalReportFIR
        rpt.Site = Me.Site
        Return rpt
    End Function
