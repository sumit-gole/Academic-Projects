...
<html>
		<head>
			...
			<link rel="stylesheet" href="ChatForum.css">
		  ...
		  <header id="header" id="home">
		    ...
		    <div class="container main-menu">
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="Dashboard.php"><img src="/kef edu/img/logo.png"/></a>
			      </div>
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="/kef edu/student/Gallery.php">Gallery</a></li>        					          		          
			...
			<section class="banner-area relative" id="home">
				<div class="overlay overlay-bg"></div>	
					...
					<div class="about-content col-lg-12" style="margin-top: -270px">
							...
							<p class="text-white link-nav"><a href="Dashboard.php">HOME </a>  &nbsp; <span style='font-size: 20px;'>&#8594;</span>  <a href="chatforum.php"> &nbsp;CHAT FORUM</a></p>
						</div>
			</section>
			<!-- End Banner Area -->
	...
	<div id="ChatDiv" style="height: 550px; border-color: grey; margin-top: 70px;">
		...
		<div id="msgArea" style="border-color: grey; overflow: auto;">
			<?php
		...
		<form method="post">
			<input type="text" id="textmsg" name="msg" placeholder="Type Your Message.." autocomplete="off" />
