					...
					<div class="container1" style="margin-left: 50px; margin-top: 80px;">
						...
						<?php
							...
							if (isset($_POST['login'])) 
							{
								...
								$q = "SELECT * FROM institute_regi where rno= '$uname' and pswd= '$pswd'";
								...
								if (mysqli_num_rows($res) > 0) 
								{
									...
									{
										$_SESSION['rno'] = $row['iname'];
									}
									//echo 'You Are Now Login..';
									
									header("location:/KEF Edu/Student/Dashboard.php");
								}
								else
								{
						...
						<form method="post">
							<input type="text" name="rno" class="e" placeholder="Institute Regi No." required /><br>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>New Member</b><a href="institute_reg.php"> Create an Account </a>
						</div>
					</div>          
				</div>
			 </div>
